...
### 内置插件指令
- `bs发言榜 [日期] [刷新]`（别名 bs水群榜）- 统计本群发言排行并出图，群管理员以上、仅群聊。日期支持 今天/昨天/N天前/本周/上周/本月/上月/7月5日/20250705 等，省略为今日实时，周期以每日 08:00 为界；带"刷新"强制重算缓存。
